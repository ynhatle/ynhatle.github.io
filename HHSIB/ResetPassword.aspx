<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="HHSIB.ResetPassword" %>
...
<!--page title-->
	...
	<!-- #BeginEditable "page_title" -->
	    <h1>Forget your Password</h1><!-- #EndEditable -->
	</div>
...
<!--icons-->
    ...
    <div id="search" style="right: 450px; top: 245px" class="body1"><h1>Reset password</h1></div>
<!--search-->
        ...
        <div id="PasswordRecoverDiv" >  
                <asp:PasswordRecovery ID="PasswordRecovery1" runat="server" BackColor="#F7F7DE" 
                    ...
                    <MailDefinition From="hhsibwebmaster@gmail.com" 
                        Subject="Your HHSIB password reset " 
                        BodyFileName="~/App_Data/LostPassword.txt">
                    </MailDefinition>
