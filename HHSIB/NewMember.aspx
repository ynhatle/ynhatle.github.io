<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewMember.aspx.cs" Inherits="HHSIB.NewMember" %>
...
<!--icons-->
    ...
    <div id="search" style="right: 450px; top: 245px" class="body1"><h1>New member</h1></div>
<!--search-->
...
<!--content tables-->
    ...
    <!-- #EndEditable -->
            ...
            <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" 
                ...
                CancelDestinationPageUrl="~/index.htm" DisplayCancelButton="True">
                <MailDefinition From="hhsibwebmaster@gmail.com" 
                    Subject="Your New HHSIB UserID Requestor " 
                    BodyFileName="~/App_Data/NewMember.txt">
                </MailDefinition>
                <WizardSteps>
