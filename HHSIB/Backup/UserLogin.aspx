<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="HHSIB.UserLogin" %>
...
<!--icons-->
    ...
    <div id="search" style="left: 400px; top: 245px" class="body1"><h1>User Login</h1></div>
<!--search-->
...
<!--content tables-->
    ...
    <table width="100%" border="0" cellpadding="5px 0x 5px 5px">
        ...
        <tr>
            <td width="60%">
            <table title="Please enter HHSParentId and Password" cellspacing="0" cellpadding="5" border="0" id="Login1" style="background-color:#F7F7DE;border-color:#CCCC99;border-width:0px;border-style:None;border-collapse:collapse;">
            <tr>
            <td>
			<table cellpadding="0" border="0" style="font-family:Verdana;font-size:10pt;height:180px;width:350px;">
				<tr>
					<td align="center" colspan="2" style="color:White;background-color:#666666;font-family:Verdana;font-size:Small;font-weight:bold;height:25px;">HHS Id Log In</td>
				</tr>
				<tr>
					<td align="right">HHS Id:</td>
					<td><asp:TextBox ID="txtUserId" runat="server" MaxLength="10" 
                        ValidationGroup="LoginValidation"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ErrorMessage="UserID must be entered." ControlToValidate="txtUserId" 
                        ValidationGroup="LoginValidation">*</asp:RequiredFieldValidator>
                    </td>
				</tr>
				<tr>
					<td align="right">Password:</td>
					<td><asp:TextBox ID="txtPswd" runat="server" MaxLength="15" TextMode="Password"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ErrorMessage="Password must be entered" ControlToValidate="txtPswd" 
                        ValidationGroup="LoginValidation">*</asp:RequiredFieldValidator>
                    </td>
				</tr>
				<tr>
					<td align="right" colspan="2">
                        ...
                        ImageUrl="~/graphics/btn_login.jpg" onclick="btnLogin_Click" />
                    </td>
				</tr>
			</table>
			</td>			
		...
		<tr>
            <td style="color:Red"><asp:Label ID="lblMessage" runat="server"></asp:Label>                
            </td>
        </tr>
        <tr>
            <td colspan="2" class="body_heading"><h4>If you have problem with Login, please send an email to <a href="mailto:hhsibwebmaster@gmail.com"><span style="color:Blue; text-decoration:underline">HHS IB Webmaster.</span></a> Thank you! 
             </h4></td>
        </tr>             
	</table>
