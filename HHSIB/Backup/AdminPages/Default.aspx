<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HHSIB.AdminPages.Default" %>
...
<!-- body1 start -->	
	...
	<table width="100%" border="0">
        <!--tr>
            <td align="left"><span style="color:blue; font-size:x-small;font-style:italic; font-family:Comic Sans MS"><asp:LoginName ID="LoginName1" runat="server" /></span></td>
            <td align="right"><span style="color:blue; font-size:x-small; font-style:italic; font-family:Comic Sans MS">
                Click here to <asp:LoginStatus ID="LoginStatus1" runat="server" /></span>
            </td>
        </tr>
        <tr><td colspan="2"></td></tr-->
        <tr>
            <td colspan="2" align="center">Select activities below (same as on left-side menu) :</td>
        </tr>
        <tr>
            <td colspan="2">                          
	            <ul >
	                <li><a href="AddStudents.aspx"><span style="color:Blue; text-decoration:underline">Add new Students</span></a></li>
	                <li><a href="DirectoryUpdate.aspx"><span style="color:Blue; text-decoration:underline">Update existing Students</span></a></li>
	                <li><a href="Homeroom.aspx"><span style="color:Blue; text-decoration:underline">Update Homerooms List</span></a></li>
	                <li><a href="UpdateCalendar.aspx"><span style="color:Blue; text-decoration:underline">Add new Events to IB Calendar</span></a></li>
	                <li><a href="ViewCalendar.aspx"><span style="color:Blue; text-decoration:underline">Update existing Events on IB Calendar</span></a></li>
	            </ul>
            </td>
        </tr>  
    </table>      
