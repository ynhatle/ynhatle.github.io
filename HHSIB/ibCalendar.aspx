<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ibCalendar.aspx.cs" Inherits="HHSIB.ibCalendar" %>
...
<style type="text/css">
    .detail_body {font:veranda; color:Black; font-size:x-small; }
</style> 
...
<body>
<form id="ibCaledarForm" runat="server">
<!--main-->
	<div id="main">
...
<!--icons-->
    ...
    <div id="search" style="left: 400px; top: 245px" class="body1"><h1>IB Calendar</h1></div>
<!--search-->
...
<!--content tables-->
	...
	<br /><br />
                <asp:Calendar ID="Calendar1" runat="server" BackColor="#CCCCCC" 
                    ...
                    FirstDayOfWeek="Sunday" NextMonthText="Next" 
                    PrevMonthText="Prev" ondayrender="Calendar1_DayRender" 
                    ShowGridLines="True" >
                    ...
                    <DayHeaderStyle Font-Bold="True" Font-Size="Small" Height="15pt" 
                        BackColor="Gray" ForeColor="White" />
                    <TitleStyle BackColor="#9999FF" BorderColor="White" BorderWidth="4px" 
                        Font-Bold="True" Font-Size="Larger" ForeColor="Black" Height="20pt" 
                        Width="50pt" />
                </asp:Calendar>                
        
    <table width="100%" border="0" cellpadding="5px 0x 5px 5px" class="body_heading">
    <tr>
        <td><h4>NOTE: If there is any event needed to add to the IB Calendar, click here to send email to <a href="mailto:hhsibwebmaster@gmail.com"><span style="color:Blue; text-decoration:underline">HHS IB Webmaster.</span></a> Thank you! 
        </h4></td>
   </tr> 
</table>        
