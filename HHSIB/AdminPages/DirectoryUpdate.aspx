...
<!--body-->		
  ...
  <%--  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <tr>            
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" CellPadding="5" Font-Size="X-Small" 
                ...
                <Fields>
                    ...
                    <asp:BoundField DataField="HomeroomId" HeaderText="HomeroomId" 
                        SortExpression="HomeroomId" />
                    ...
                    <asp:BoundField DataField="ParentEmail2" HeaderText="ParentEmail2" SortExpression="ParentEmail2" />
                    <asp:BoundField DataField="Homeroom" HeaderText="Homeroom" SortExpression="Homeroom" />
                </Fields>
	...
	<asp:LinqDataSource ID="LinqDataSource1" runat="server" 
            ...
            TableName="StudentIBs" 
            EnableDelete="True" 
            EnableUpdate="True"             
            Where="StudentNo == @StudentNo" EntityTypeName=""                
            >
        <WhereParameters>
