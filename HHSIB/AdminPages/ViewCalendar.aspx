...
<!--content tables-->
    ...
    <div class="Vertical_Menu">
	    <ul class="myVerticalMenu">
	        ...
	        <li><a href="AdminPages/AddStudents.aspx">Add Students</a></li>	        	  
	        <li><a href="AdminPages/DirectoryUpdate.aspx">Update Students</a></li>	           	        	        		
		    <li><a href="AdminPages/Homeroom.aspx">Update Homeroom</a></li>
		    <li><a href="AdminPages/UpdateCalendar.aspx">Add to Calendar</a></li>
	    ...
	    <tr>
	        <td>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                     AutoGenerateColumns="False" DatakeyNames="id" Caption="Calendar By Dates" CellPadding="5" 
                    
                    BackColor="White" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating"  >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="IBEVent" SortExpression="IBEVent">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("IBEVent") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("IBEVent") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="IBDate" SortExpression="IBDate">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server"  Text='<%# Bind("IBDate","{0:MM/dd/yyyy}") %>'  ></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server"  Text='<%# Bind("IBDate","{0:MM/dd/yyyy}") %>'  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
