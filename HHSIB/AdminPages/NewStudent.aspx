<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewStudent.aspx.cs" Inherits="HHSIB.AdminPages.NewStudent" %>
...
<!--icons-->
    ...
    <div id="search" style="right: 450px; top: 245px" class="body1"><h1>New Students</h1></div>
...
<!-- body1 start -->	
	...
	<table width="100%" border="0">
        ...
        <tr>
            <td colspan="2" align="center">Please add all new student. Click DONE when finishing all.</td>
        </tr>        
    </table>      
...
<!-- body1 end-->	
	    <asp:DetailsView ID="DetailsView1" runat="server" 
            ...
            oniteminserted="DetailsView1_ItemInserted" Width="350px" 
            onitemdeleted="DetailsView1_ItemDeleted">
            <CommandRowStyle BackColor="#CC3300" />
            <FieldHeaderStyle BackColor="#666666" Font-Bold="True" ForeColor="White" 
                Width="100px" />
            <Fields>
                <asp:BoundField DataField="StudentNo" HeaderText="StudentNo" 
                    InsertVisible="False" ReadOnly="True" SortExpression="StudentNo" />
	...
	<br />
        <asp:LinqDataSource ID="LinqDataSource1" runat="server" 
            ContextTypeName="HHSIB.IBStudentsDataContext" EnableInsert="True" 
            TableName="IB_Students" 
            Where="StudentNo == @StudentNo">
            <WhereParameters>
                <asp:ControlParameter ControlID="DetailsView1" DefaultValue="0" 
                    Name="StudentNo" PropertyName="SelectedValue" Type="Int32" />
            </WhereParameters>
        </asp:LinqDataSource>
