<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateCalendar.aspx.cs" Inherits="HHSIB.AdminPages.UpdateCalendar" %>
...
<!--icons-->
    ...
    <div id="search" style="left: 400px; top: 245px" class="body1"><h1>Add Calendar</h1></div>
...
<!-- body1 start -->
    ...
    <table width="100%" border="0" cellpadding="5px 5px 5px 5px">
        ...
        <tr>
            <td class="body1">From Date: </td>
            <td class="body1">
                <asp:DropDownList ID="ddlMth1" runat="server" Width="40px" 
                    onselectedindexchanged="ddlMth1_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>/
                <asp:DropDownList ID="ddlDay1" runat="server" Width="40px" 
                    onselectedindexchanged="ddlDay1_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>/
                <asp:DropDownList ID="ddlYr1" runat="server" Width="75px" 
                    onselectedindexchanged="ddlYr1_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList> (MM/DD/YYYY)
            </td>            
        </tr>    
        <tr>
            <td class="body1">To Date: </td>
            <td class="body1">
                <asp:DropDownList ID="ddlMth2" runat="server" Width="40px"></asp:DropDownList>/
                <asp:DropDownList ID="ddlDay2" runat="server" Width="40px"></asp:DropDownList>/
                <asp:DropDownList ID="ddlYr2" runat="server" Width="75px"></asp:DropDownList> (MM/DD/YYYY)
            </td>                     
        </tr>
        
        <tr>
            <td colspan="2">Event Description : 
                <asp:TextBox ID="txtDesc" runat="server" 
                    Width="250px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ErrorMessage=" Event Description must be entered." Display="Dynamic" 
        ...
        <tr>
            <td width="30%">            
                <asp:ImageButton ID="btnAdd" runat="server" ImageUrl="~/graphics/btn_add.gif" 
