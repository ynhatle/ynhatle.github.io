...
<!-- body1 start -->	
	...
	<table width="100%" border="0">
	    <tr>
	        <td colspan="2">Click <strong>Insert</strong> to add new Homeroom teacher name, <strong>Refresh</strong> to view the list.</td>
	    </tr>        
        <tr>
            <td valign="top">
                <table>
            ...
            ValidationGroup="NewHomeroom" InitialValue="">*</asp:RequiredFieldValidator></td>--%>
                    <td>
                ...
                <asp:DetailsView ID="DetailsView1" runat="server" 
                    ...
                    Caption="New Homeroom" DefaultMode="Insert" Font-Bold="True" onitemcommand="DetailsView1_ItemCommand" OnPageIndexChanging="DetailsView1_PageIndexChanging"  
                    >
                    ...
                    <Fields>
                        ...
                        <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" ValidateRequestMode="Enabled" />
                ...
                <asp:ImageButton ID="btnLoad" runat="server" 
                    ImageUrl="~/graphics/btn_refresh.jpg" onclick="btnLoad_Click" Height="26px" />
                </td>
                    <%--<td align="center">
                        <br />
                        <asp:ImageButton ID="tbnAdd" runat="server" ImageUrl="~/graphics/btn_add.gif" OnClick="tbnAdd_Click" style="height: 24px" />
                    </td>--%>
                </tr>                
                </table>
	...
	<asp:LinqDataSource ID="LinqDataSource1" runat="server" 
            ...
            TableName="HomeroomIBs" 
            EnableDelete="True"
            EnableInsert="True"
            EnableUpdate="True" OrderBy="Name" EntityTypeName=""             
            >
        </asp:LinqDataSource>   
        </ContentTemplate>
    </asp:UpdatePanel>
