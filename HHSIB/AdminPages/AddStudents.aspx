<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStudents.aspx.cs" Inherits="HHSIB.AdminPages.AddStudents" %>
...
<!--icons-->
    ...
    <div id="search" style="left: 400px; top: 245px" class="body1"><h1>New Students</h1></div>
...
<!-- body1 start -->	
	...
	<table width="100%" border="0">
	    <tr>
	        <td colspan="2">Please enter all info, click <strong>Add </strong>to insert.<span style="color:Red">(* indicates required field)</span></td>
        ...
        <tr>
            <td width="35%"><span style="color:Red">* </span>Last Name :</td>
            <td><asp:TextBox ID="txtLastName" runat="server" MaxLength="50"></asp:TextBox>
            <asp:RequiredFieldValidator ID="valLastName" runat="server" 
            ControlToValidate="txtLastName" ErrorMessage="Last name must be entered" 
            ValidationGroup="NewStudent" InitialValue="">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td><span style="color:Red">* </span>First Name :</td>
            <td><asp:TextBox ID="txtFirstName" runat="server" MaxLength="50"></asp:TextBox>
            <asp:RequiredFieldValidator ID="valFirstName" runat="server" 
            ControlToValidate="txtFirstName" ErrorMessage="First Name must be entered." 
            ValidationGroup="NewStudent" InitialValue="">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td ><span style="color:Red">* </span>Class Of :</td>
            <td>
        ...
        <tr>
            <td >Address :</td>
            <td><asp:TextBox ID="txtAddress" runat="server" MaxLength="150"></asp:TextBox></td>
        </tr>
        <tr>
            <td >City :</td>
            <td><asp:TextBox ID="txtCity" runat="server" MaxLength="30"></asp:TextBox></td>
        </tr>
        <tr>
            <td >ZipCode (nnnnn): </td>
            <td><asp:TextBox ID="txtZipcode" runat="server" MaxLength="10"></asp:TextBox>
            <asp:RegularExpressionValidator ID="valZipCode" runat="server" 
            ControlToValidate="txtZipcode" ErrorMessage="Zipcode is not valid." 
            ValidationExpression="\d{5}(-\d{4})?" ValidationGroup="NewStudent">*</asp:RegularExpressionValidator></td>
        </tr>
        <tr>
            <td >Phone (nnn-nnn-nnnn): </td>
            <td><asp:TextBox ID="txtPhone1" runat="server" MaxLength="12"></asp:TextBox><asp:RegularExpressionValidator ID="valPhone1" runat="server" 
            ControlToValidate="txtPhone1" ErrorMessage="Phone number is not valid" 
            ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}" 
            ValidationGroup="NewStudent">*</asp:RegularExpressionValidator></td>
        </tr>
        <tr>
            <td >Alt.Phone (nnn-nnn-nnnn): </td>
            <td><asp:TextBox ID="txtPhone2" runat="server" MaxLength="12"></asp:TextBox>
            <asp:RegularExpressionValidator ID="valPhone2" runat="server" 
            ControlToValidate="txtPhone2" ErrorMessage="Alt Phone is not valid" 
            ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}"             
            ValidationGroup="NewStudent">*</asp:RegularExpressionValidator></td>
        </tr>
        <tr>
            ...
            ValidationGroup="NewStudent">*</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td >Homeroom :</td>
            <td>
                <asp:DropDownList ID="ddlHomeroom" DataTextField ="Name" DataValueField="ID" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td >Parent Names :</td>
            <td><asp:TextBox ID="txtParent" runat="server" MaxLength="100"></asp:TextBox></td>
        </tr>
        <tr>
            <td >Parent Email1 :</td>
            <td><asp:TextBox ID="txtPEmail1" runat="server" MaxLength="50"></asp:TextBox>
            <asp:RegularExpressionValidator ID="valPEmail1" runat="server" 
            ControlToValidate="txtPEmail1" ErrorMessage="Parent Email1 is not valid" 
            ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
            ValidationGroup="NewStudent">*</asp:RegularExpressionValidator></td>
        </tr>
        <tr>
            <td >Parent Email2 :</td>
            <td><asp:TextBox ID="txtPEmail2" runat="server" MaxLength="50"></asp:TextBox>
            <asp:RegularExpressionValidator ID="valPEmail2" runat="server" 
            ControlToValidate="txtPEmail2" ErrorMessage="Parent Email2 is not valid" 
            ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
            ValidationGroup="NewStudent">*</asp:RegularExpressionValidator>    
            </td>
        </tr>
        <tr>
            <td colspan="2" style="color:Red; font-weight:bold;"><asp:Label ID="lblMsg" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center"><asp:ImageButton ID="btnAdd" runat="server" 
                    ImageUrl="~/graphics/btn_add.gif" onclick="btnAdd_Click" /></td> 
            <td align="center">
                <asp:ImageButton ID="btnCancel" runat="server" 
                    ImageUrl="~/graphics/btn_cancel.jpg" onclick="btnCancel_Click" />
            </td>           
        </tr>
