...
namespace HHSIB.AdminPages
{
    public partial class AddStudents : System.Web.UI.Page
    {
        ...
        private void GetHomerooms()
        {
            ...
            var results = from p in db.HomeroomIBs
                          orderby p.Name
        ...
        private bool AddStudent()
        {
            ...
            try
            {
                ...
                newst.HomeroomId = Convert.ToInt16(ddlHomeroom.SelectedItem.Value);
                db.StudentIBs.InsertOnSubmit(newst);
                db.SubmitChanges();
                val = true;
            }
            catch (Exception ex)
